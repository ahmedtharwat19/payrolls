...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        // ✅ AuthService و EmployeeController كـ ChangeNotifier
        ChangeNotifierProvider.value(value: authService),
        ChangeNotifierProvider(create: (_) => EmployeeController()),

        // ✅ TaxService و InsuranceService كـ ChangeNotifier
        // حتى نتمكن من استخدام context.watch() للإعلام بالتغييرات
