...
import '../shared/adaptive_form_layout.dart';
                ...
                children: [
                  AdaptiveFormField(
                    child: TextFormField(
                      ...
                      validator: (v) =>
                          v?.isEmpty ?? true ? 'name_required'.tr() : null,
                  ...
                  AdaptiveFormField(
                    child: TextFormField(
                      ...
                      onSaved: (v) =>
                          _data['hireDate'] = v ?? DateTime.now().toIso8601String(),
                    ),
                  ),
                  AdaptiveFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon: IconButton(
                            ...
                            onPressed: () async {
                              ...
                              if (date != null) {
                                setState(() =>
                                    _data['resignationDate'] = date.toIso8601String());
                              }
                            },
                          ),
                        ),
                  ...
                  AdaptiveFormField(
                    child: DropdownButtonFormField<String>(
                      ...
                      items: _contractTypes.map((e) {
                        return DropdownMenuItem<String>(value: e, child: Text(e.tr()));
                      }).toList(),
